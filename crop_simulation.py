...
from manual_grow_dialog_class import * #provides manual grow dialog window
...
class CropWindow(QMainWindow):
    ...
    def create_select_crop_layout(self):
        #this is the inital layout of the window - to select the crop type
    ...
    def create_view_crop_layout(self, crop_type):
        ...
        #ensure the crop view appaers a certain size
    ...
    def update_crop_view_status(self):
        ...
        #update the text fields of line edits
